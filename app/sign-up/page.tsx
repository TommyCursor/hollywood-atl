      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color: "#888", fontSize: 14 }}>
            We sent a confirmation link to <strong style={{ color: "#8B5CF6" }}>{email}</strong>. Click it to activate your account.
          </p>
          <a href="/sign-in" style={{ color: "#8B5CF6", fontSize: 13, marginTop: 20, display: "block" }}>Back to Sign In</a>
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{
      ...
      <form onSubmit={handleSignUp} style={{
        ...
        <h2 style={{ color: "#fff", fontSize: 20, fontWeight: 700, margin: 0, textAlign: "center" }}>Create Account</h2>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
          <label style={{ color: "#888", fontSize: 12 }}>Full Name</label>
          <input
        ...
        <div style={{ textAlign: "center", color: "#555", fontSize: 13 }}>
          ...
          <a href="/sign-in" style={{ color: "#8B5CF6", textDecoration: "none" }}>Sign in</a>
        </div>
      </form>
    </div>
  );
